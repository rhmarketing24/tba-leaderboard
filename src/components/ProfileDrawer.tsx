      ...
      {open && (
        <>
          ...
          >
            ...
            <div className="mt-auto px-4 pb-4 sticky bottom-0">
                ...
                <div className="flex justify-center gap-4">
                  ...
                  >
                    <svg width="26" height="26" viewBox="0 0 100 100">
                      <defs>
                        <linearGradient id="baseGradProfile" x1="0" y1="0" x2="1" y2="1">
                          <stop offset="0%" stopColor="#7AA2FF" />
                          <stop offset="100%" stopColor="#0052FF" />
                        </linearGradient>
                      </defs>
                      <rect x="12" y="12" width="76" height="76" rx="18" fill="url(#baseGradProfile)" />
                    </svg>
                  </a>
                  ...
                  >
                    <svg width="30" height="30" viewBox="0 0 100 100">
                      <defs>
                        <radialGradient id="zoraGradProfile" cx="35%" cy="35%" r="65%">
                          <stop offset="0%" stopColor="#B6C6FF" />
                          <stop offset="55%" stopColor="#6B5CFF" />
                          <stop offset="100%" stopColor="#3A1C1C" />
                        </radialGradient>
                      </defs>
                      <circle cx="50" cy="50" r="45" fill="url(#zoraGradProfile)" />
                    </svg>
                  </a>
